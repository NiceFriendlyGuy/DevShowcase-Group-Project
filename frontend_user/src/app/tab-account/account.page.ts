...
import { IonHeader, IonCard,IonToolbar,IonFab, IonFabButton, IonTitle, IonContent, IonButton, IonCheckbox, IonButtons, IonMenuButton, IonIcon, IonLabel, AlertController, ToastController } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [CommonModule,IonFab, IonFabButton, IonCard, IonHeader, IonToolbar, IonTitle, IonContent, IonButton, IonIcon,IonCheckbox, IonLabel, ProfileComponent, ProfileEditComponent],
})
export class AccountPage {
  ...
  async confirmDeleteProject(projectId: number) {
    const alert = await this.alertController.create({
      ...
      message: 'Are you sure you want to remove this author from the project? The project will not be deleted',
